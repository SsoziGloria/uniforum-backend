...
<div class="min-h-screen bg-slate-50">
    ...
    <div class="max-w-7xl mx-auto px-6 py-10">
        ...
        <div class="flex flex-col md:flex-row gap-4 justify-between items-center mb-8">
            <form method="GET" action="{{ route('student.groups.browse') }}" class="w-full md:w-2/3 flex gap-2">
                <div class="relative flex-1">
                    ...
                    @if(request('search'))
                        <a href="{{ route('student.groups.browse') }}" 
            ...
            <a href="{{ route('student.groups.create') }}"
                ...
                <div class="bg-white rounded-2xl border border-slate-200 p-6 flex flex-col justify-between">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="flex gap-3">
                            ...
                            @else
                                <a href="{{ route('student.groups.join', $groupId) }}"
